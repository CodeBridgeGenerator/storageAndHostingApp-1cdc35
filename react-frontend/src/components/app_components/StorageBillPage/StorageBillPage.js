...
const StorageBillPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Storage Bill",
          type: "error",
          message: error.message || "Failed get Storage Bill",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("storageBill").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
