...
const ProjectgcpEditDialogComponent = (props) => {
  ...
  const onSave = async () => {
    let _data = {
      ...
      env: _entity?.env,
      gcpProjectId: _entity?.gcpProjectId,
      location: _entity?.location,
      imageUri: _entity?.imageUri,
      imageName: _entity?.imageName,
      authentication: _entity?.authentication,
      serviceAccount: _entity?.serviceAccount,
      memory: _entity?.memory,
      cpu: _entity?.cpu,
      concurrency: _entity?.concurrency,
      maxInstances: _entity?.maxInstances,
      minInstances: _entity?.minInstances,
      vpcConnector: _entity?.vpcConnector,
      vpcEgress: _entity?.vpcEgress,
    };
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Edit info",
        message: "Info projectgcp updated successfully",
      });
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="projectgcp-edit-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="gcpProjectId"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.gcpProjectId}
              onChange={(e) => setValByKey("gcpProjectId", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="imageUri"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.imageUri}
              onChange={(e) => setValByKey("imageUri", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="imageName"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.imageName}
              onChange={(e) => setValByKey("imageName", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field flex">
          <span className="align-items-center">
            ...
            <Checkbox
              id="authentication"
              className="ml-3"
              checked={_entity?.authentication}
              onChange={(e) => setValByKey("authentication", e.checked)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="serviceAccount"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.serviceAccount}
              onChange={(e) => setValByKey("serviceAccount", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="memory"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.memory}
              onChange={(e) => setValByKey("memory", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              ...
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.cpu}
              onChange={(e) => setValByKey("cpu", e.target.value)}
            />
          </span>
          <small className="p-error">
            {!_.isEmpty(error["cpu"]) && (
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="concurrency"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.concurrency}
              onChange={(e) => setValByKey("concurrency", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="maxInstances"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.maxInstances}
              onChange={(e) => setValByKey("maxInstances", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="minInstances"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.minInstances}
              onChange={(e) => setValByKey("minInstances", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="vpcConnector"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.vpcConnector}
              onChange={(e) => setValByKey("vpcConnector", e.target.value)}
            />
          </span>
          <small className="p-error">
        ...
        <div className="col-12 md:col-6 field">
          <span className="align-items-center">
            ...
            <InputText
              id="vpcEgress"
              className="w-full mb-3 p-inputtext-sm"
              value={_entity?.vpcEgress}
              onChange={(e) => setValByKey("vpcEgress", e.target.value)}
            />
          </span>
          <small className="p-error">
...
export default connect(mapState, mapDispatch)(ProjectgcpEditDialogComponent);
