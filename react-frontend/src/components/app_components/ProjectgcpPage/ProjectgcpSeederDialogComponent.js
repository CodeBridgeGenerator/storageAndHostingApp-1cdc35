...
import seederData from "./projectgcp.seeder.json";
...
const ProjectgcpSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProjectgcpSeederDialogComponent);
