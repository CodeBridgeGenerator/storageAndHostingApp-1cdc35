...
const ProjectgcpCreateDialogComponent = (props) => {
  ...
  const onSave = async () => {
    ...
    let _data = {
      ...
      authentication: _entity?.authentication || false,
    ...
    try {
      ...
      props.alert({
        type: "success",
        title: "Create info",
        message: "Info Projectgcp created successfully",
      });
      ...
      props.alert({
        type: "error",
        title: "Create",
        message: "Failed to create in Projectgcp",
      });
    }
    setLoading(false);
  };
  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="projectgcp-create-dialog-component"
      >
