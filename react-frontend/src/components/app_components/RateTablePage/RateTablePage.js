    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Rate Table",
          type: "error",
          message: error.message || "Failed get Rate Table",
        });
      });
