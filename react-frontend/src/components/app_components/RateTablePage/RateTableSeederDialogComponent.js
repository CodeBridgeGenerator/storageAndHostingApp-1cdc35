...
import seederData from "./rateTable.seeder.json";
...
const RateTableSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(RateTableSeederDialogComponent);
