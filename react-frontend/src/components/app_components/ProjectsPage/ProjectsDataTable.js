...
<Column field="projectName" header="Project Name" body={pTemplate1} filter={selectedFilterFields.includes("projectName")} hidden={selectedHideFields?.includes("projectName")}  sortable style={{ minWidth: "8rem" }} />
