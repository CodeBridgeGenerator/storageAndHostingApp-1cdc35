...
const AiEmbeddingsPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Ai Embeddings",
          type: "error",
          message: error.message || "Failed get Ai Embeddings",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("aiEmbeddings").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
