...
import seederData from "./aiEmbeddings.seeder.json";
...
const AiEmbeddingsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AiEmbeddingsSeederDialogComponent);
