...
import seederData from "./hosting.seeder.json";
...
const HostingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(HostingSeederDialogComponent);
