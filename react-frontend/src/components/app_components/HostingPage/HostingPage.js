    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Hosting",
          type: "error",
          message: error.message || "Failed get Hosting",
        });
      });
