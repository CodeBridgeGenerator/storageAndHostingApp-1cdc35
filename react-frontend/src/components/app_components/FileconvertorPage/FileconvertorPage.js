...
const FileconvertorPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Fileconvertor",
          type: "error",
          message: error.message || "Failed get Fileconvertor",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("fileconvertor").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
