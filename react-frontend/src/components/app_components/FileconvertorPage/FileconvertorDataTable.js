    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="File Size"
          body={pTemplate1}
          filter={selectedFilterFields.includes("fileSize")}
          hidden={selectedHideFields?.includes("fileSize")}
          sortable
          style={{ minWidth: "8rem" }}
        />
      ...
      <Dialog
        header="Upload Fileconvertor Data"
        visible={showUpload}
