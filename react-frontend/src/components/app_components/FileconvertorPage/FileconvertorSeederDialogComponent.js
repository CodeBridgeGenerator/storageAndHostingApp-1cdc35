...
import seederData from "./fileconvertor.seeder.json";
...
const FileconvertorSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(FileconvertorSeederDialogComponent);
