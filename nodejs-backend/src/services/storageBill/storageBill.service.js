const { StorageBill } = require("./storageBill.class");
const createModel = require("../../models/storageBill.model");
const hooks = require("./storageBill.hooks");
...
module.exports = function (app) {
  ...
  app.use("/storageBill", new StorageBill(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("storageBill");

  // Get the schema of the collections
  app.get("/storageBillSchema", function (request, response) {
