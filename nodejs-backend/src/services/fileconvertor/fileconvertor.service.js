const { Fileconvertor } = require("./fileconvertor.class");
const createModel = require("../../models/fileconvertor.model");
const hooks = require("./fileconvertor.hooks");
...
module.exports = function (app) {
  ...
  app.use("/fileconvertor", new Fileconvertor(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("fileconvertor");

  // Get the schema of the collections 
  app.get("/fileconvertorSchema", function (request, response) {
