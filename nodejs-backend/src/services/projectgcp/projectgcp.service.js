const { Projectgcp } = require("./projectgcp.class");
const createModel = require("../../models/projectgcp.model");
const hooks = require("./projectgcp.hooks");
...
module.exports = function (app) {
  ...
  app.use("/projectgcp", new Projectgcp(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("projectgcp");

  // Get the schema of the collections 
  app.get("/projectgcpSchema", function (request, response) {
