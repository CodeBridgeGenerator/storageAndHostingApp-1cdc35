const { RateTable } = require("./rateTable.class");
const createModel = require("../../models/rateTable.model");
const hooks = require("./rateTable.hooks");
...
module.exports = function (app) {
  ...
  app.use("/rateTable", new RateTable(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("rateTable");

  // Get the schema of the collections
  app.get("/rateTableSchema", function (request, response) {
