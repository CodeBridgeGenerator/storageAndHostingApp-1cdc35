const { AiEmbeddings } = require("./aiEmbeddings.class");
const createModel = require("../../models/aiEmbeddings.model");
const hooks = require("./aiEmbeddings.hooks");
...
module.exports = function (app) {
  ...
  app.use("/aiEmbeddings", new AiEmbeddings(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("aiEmbeddings");

  // Get the schema of the collections 
  app.get("/aiEmbeddingsSchema", function (request, response) {
